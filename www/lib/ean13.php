...
class Ean13
{
    ...
    var $_fontfile = "img/fonts/LiberationSans-Regular.ttf";
    ...
    function draw($text, $imgtype = 'png')
    {
        ...
        $bbox = imagettfbbox($this->_font, 0,  $this->_fontfile, "0");
        $w = $bbox[4]-$bbox[0];
        $h = $bbox[1]-$bbox[5];
        ...
        $barcodelongheight = (int) (imagefontheight($this->_font)/2) + $this->_barcodeheight + $h/2 + 10;
        ...
        // print first digit
        imagettftext ($img, $this->_font, 0, $xpos-$w, $this->_barcodeheight + $h + 10, $black, $this->_fontfile, $key);

     //   imagestring($img, $this->_font, $xpos, $this->_barcodeheight, $key, $black);
        $xpos= imagefontwidth($this->_font) + 1 + $w;
        ...
        for ($idx = 1; $idx < 7; $idx ++) {
            ...
            imagettftext($img, $this->_font, 0, $xpos + 3*$this->_barwidth, $this->_barcodeheight + $h + 10, $black, $this->_fontfile, $value);
